...
| Git 规范                                                          | [commitlint](https://commitlint.js.org/#/)                 | [en-commitlint-config-encode](https://www.npmjs.com/package/en-commitlint-config-encode)     |
...
- 写入各种配置文件，包括：
  ...
  - `commitlint.config.js`：commitlint 配置（继承 `en-commitlint-config-encode`）
